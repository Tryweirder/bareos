...
find_program(PS ps)
if(PS)
    set(PSCMD ${PS} PARENT_SCOPE)
    if(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
        set(PSCMD "${PS} -e" PARENT_SCOPE)
    endif()
    if(${CMAKE_SYSTEM_NAME} MATCHES "SunOS")
        set(PSCMD "${PS} -e -o pid,comm" PARENT_SCOPE)
    endif()
    if(${CMAKE_SYSTEM_NAME} MATCHES "FreeBSD")
        set(PSCMD "${PS} -ax -o pid,command" PARENT_SCOPE)
    endif()
    if(${CMAKE_SYSTEM_NAME} MATCHES "HP-UX")
        set(PSCMD "UNIX95=1; ${PS} -e -o pid,comm" PARENT_SCOPE)
    endif()
endif()
